...
% \]
% configurations. This is more than the number of atoms in the universe. In reality, we apply engineering knowledge constraints, for example that the total number of voxels that can be occupied is some fraction of the $128\times128\times128$ grid, or that all surfaces must be convex. Consequently, the search space has many constraints and only a small feasible region \citep{Shi2010} increasing the risk of missing global optimum solutions.
