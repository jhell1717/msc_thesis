...
\begin{titlepage}
  ...
  % Place logo top-left without affecting centring of the rest:
  \noindent\makebox[0pt][l]{\includegraphics[width=0.18\textwidth]{figures/uoh.jpg}}%

  % Space from top of page to title block (adjust as needed)
  \vspace*{1.2cm}

  % Main title block - centered normally
  \begin{center}
  ...
  % Date and copyright - visible at bottom
  \begin{center}
    {\large September 2025\par}
    \vspace{0.4cm}
    {\small \textcopyright 2025, Joshua Hellewell\par}
  \end{center}
\end{titlepage}
