...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/VAEmodels/model3/varying_z3_z4_fixed_z1=0.0_z2=0.0.png}
    \caption{Model 3 - Latent space visualisation with $Z_1$ = 0, $Z_2$ = 0}
    \label{fig:model3_fixz1z2}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/VAEmodels/model3/varying_z1_z4_fixed_z2=0.0_z3=0.0.png}
    \caption{Model 3 - Latent space visualisation with $Z_2$ = 0, $Z_3$ = 0}
    \label{fig:model3_fixz2z3}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{figures/VAEmodels/model4/varying_z2_z4_fixed_z1=0.0_z3=0.0_z5=0.0.png}
    \caption{Model 4 - Latent space visualisation with $Z_1$ = 0, $Z_3$ = 0, $Z_5$ = 0}
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.8\textwidth}
  \centering
    \includegraphics[height=0.3\textheight]{figures/VAEmodels/model4/varying_z2_z4_fixed_z1=0.0_z3=0.0_z5=0.0.png}
    \caption{$Z_1=0.0 \; Z_3=0.0 \; Z_5=0.0$}
    \label{fig:model4_fixz1z3z5_latent}
  \end{subfigure}
  \par\medskip
  \begin{subfigure}{0.8\textwidth}
  \centering
    \includegraphics[height=0.3\textheight]{figures/VAEmodels/model4/varying_z2_z3_fixed_z1=0.0_z4=0.0_z5=0.0.png}
    \caption{$Z_1=0.0 \; Z_4=0.0 \; Z_5=0.0$}
    \label{fig:model4_fixz1z4z5_latent}
  \end{subfigure}
  \par\medskip
  \begin{subfigure}{0.8\textwidth}
  \centering
    \includegraphics[height=0.3\textheight]{figures/VAEmodels/model4/varying_z2_z5_fixed_z1=0.0_z3=0.0_z4=0.0.png}
    \caption{$Z_1=0.0 \; Z_3=0.0 \; Z_4=0.0$}
    \label{fig:model4_fixzz1z3z4_latent}
  \end{subfigure}
